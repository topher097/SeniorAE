...
for i=1:flights
    if choice == 1
        DesignProblem03('Controller', 'datafile', 'data.mat', 'launchangle', deg2rad(launch), 'display', true, 'seed', i)
    elseif choice == 0
        DesignProblem03('Controller', 'datafile', 'data.mat', 'launchangle', deg2rad(launch), 'display', false, 'seed', i)
    end
    load('data.mat');
