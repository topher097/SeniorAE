...
% Set RNG seed if one is specified
...
if (exist(params.roadfile,'file')==2)
    ...
    error('Road file %s does not exist.\n',params.roadfile);
end

% Copy the EOM
if (~(exist(fullfile(params.dirname, 'DP04_eom.mat'),'file')==2))
    error('EOM file ''DP04_eom.mat'' does not exist in %s.\n',params.dirname);
end
