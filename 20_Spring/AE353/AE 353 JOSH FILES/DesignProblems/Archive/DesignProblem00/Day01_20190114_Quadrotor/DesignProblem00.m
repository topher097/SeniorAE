...
%                           will add an unknown disturbance to the thrust
%
...
process.t = 0;
% Z-Position
process.z = 3*(-1+(2*rand));
% Z-Velocity
process.zdot = 0.5*randn;
...
d_z = zdot;
d_zdot = (thrust/process.mTrue)-process.g;
% pack xdot
xdot = [d_z; d_zdot];
end
