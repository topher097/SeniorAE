...
theta_list = FileData.theta;
theta1_list = FileData.thetawithstep1;
theta2_list = FileData.thetawithstep2;
theta3_list = FileData.thetawithstep3;
...
data_write = [w_theta_t; w_theta_a]';
...
data_write = [w_theta1_t; w_theta1_a]';
cHeader = {'time (s)' 'theta (rad)'}; %dummy header
commaHeader = [cHeader;repmat({','},1,numel(cHeader))]; %insert commaas
commaHeader = commaHeader(:)';
textHeader = cell2mat(commaHeader); %cHeader in text with commas
