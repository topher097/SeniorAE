...
%   subs( ..., [x; u], [x_e; u_e]) plugs in the equilibrium point_e
...
%   x' * Q * x + u' * R * u
%
% If you make Q(1, 1) bigger, then you are increasing the cost of the
% first element of the state - in this case, the error in z position.
% Since K is chosen to minimize cost, then if you implemented the resulting
% controller, you would expect to see the z position error decrease (or at
% least, to decrease more rapidly).
%
% If you make R(1, 1) bigger, then you are increasing the cost of the
% first element of the input - in this case, the total thrust from all the
